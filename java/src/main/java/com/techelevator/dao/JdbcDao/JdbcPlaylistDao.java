...
public class JdbcPlaylistDao implements PlaylistDao {
	...
	public List<Song> getSongsInPlaylist(int playlistId) {
		...
		String sql = "SELECT song_id, song_name, artist, genre, user_genre, spotify_id, votes, album_art FROM song INNER JOIN playlist_song USING(song_id) WHERE playlist_id = ?";
		try {
